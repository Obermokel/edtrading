...
public class Mats2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //File sourceFile = new File(Constants.SURFACE_MATS_DIR, Constants.SURFACE_MATS_SUBDIR + "\\2016-09-27 08-46-22 Col 132 Sector DB-W d2-38.png");
        for (File sourceFile : selectAllScreenshots()) {
            ...
            logger.trace("Original image size: " + originalImage.getWidth() + "x" + originalImage.getHeight());
