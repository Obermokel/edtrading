...
public class BodyScannerTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File sourceFile = new File(Constants.SURFACE_MATS_DIR, Constants.SURFACE_MATS_SUBDIR + "\\2016-09-28 07-58-50 Har Itari.png");
        ...
        File[] templateTextDirs = learnedSetDir.listFiles(new FileFilter() {
            ...
            public boolean accept(File file) {
                if (learnedSetDir.getName().contains("FIXED")) {
                    return file.isDirectory() && file.getName().equals("D");
                } else {
