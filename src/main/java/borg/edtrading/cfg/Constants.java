...
public interface Constants {
	 ...
	 */
	File DISTANCES_SCREENSHOTS_DIR = new File(System.getProperty("user.home"), "Google Drive\\Elite Dangerous\\Trilateration");
	...
	Set<String> SCOOPABLE_SPECTRAL_CLASSES = new HashSet<>(
			Arrays.asList("O", "B", "A", "F", "G", "K", "K_RedGiant", "K_OrangeGiant", "M", "M_RedGiant", "M_OrangeGiant"));
