...
public interface Constants {
    ...
    File SYSTEMS_FILE = new File(System.getProperty("user.home"), "Downloads\\systems (4).csv");
    ...
    File BODIES_FILE = new File(System.getProperty("user.home"), "Downloads\\bodies (4).jsonl");
