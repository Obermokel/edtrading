...
public interface Constants {
    ...
    File SYSTEMS_FILE = new File(System.getProperty("user.home"), "Downloads\\systems-2016-11-21.csv");
    ...
    File BODIES_FILE = new File(System.getProperty("user.home"), "Downloads\\bodies-2016-11-21.jsonl");
