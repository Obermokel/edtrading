...
public interface Constants {
    ...
    File SYSTEMS_FILE = new File(System.getProperty("user.home"), "Downloads\\systems (7).csv");
    ...
    File BODIES_FILE = new File(System.getProperty("user.home"), "Downloads\\bodies (7).jsonl");
