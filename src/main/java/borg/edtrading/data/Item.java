...
public enum Item {
    ...
    CORE_DYNAMICS_COMPOSITES("CORE DYNAMICS COMPOSITES","fedcorecomposites", ItemType.MANUFACTURED, 0),
    ...
    FLAWED_FOCUS_CRYSTALS("FLAWED FOCUS CRYSTALS","uncutfocuscrystals", ItemType.MANUFACTURED, 0),
    ...
    GRID_RESISTORS("GRID RESISTORS","gridresistors", ItemType.MANUFACTURED, 0),
    ...
    HYBRID_CAPACITORS("HYBRID CAPACITORS","hybridcapacitors", ItemType.MANUFACTURED, 0),
    ...
    MILITARY_GRADE_ALLOYS("MILITARY GRADE ALLOYS","militarygradealloys", ItemType.MANUFACTURED, 0),
    MILITARY_SUPERCAPACITORS("MILITARY SUPERCAPACITORS","militarysupercapacitors", ItemType.MANUFACTURED, 0),
    ...
    POLYMER_CAPACITORS("POLYMER CAPACITORS","polymercapacitors", ItemType.MANUFACTURED, 0),
    PRECIPITATED_ALLOYS("PRECIPITATED ALLOYS","precipitatedalloys", ItemType.MANUFACTURED, 0),
    PROPRIETARY_COMPOSITES("PROPRIETARY COMPOSITES","fedproprietarycomposites", ItemType.MANUFACTURED, 0),
    PROTO_HEAT_RADIATORS("PROTO HEAT RADIATORS","protoheatradiators", ItemType.MANUFACTURED, 0),
    PROTO_LIGHT_ALLOYS("PROTO LIGHT ALLOYS", "protolightalloys", ItemType.MANUFACTURED, 0),
    PROTO_RADIOLIC_ALLOYS("PROTO RADIOLIC ALLOYS","protoradiolicalloys", ItemType.MANUFACTURED, 0),
    ...
    ATYPICAL_DISRUPTED_WAKE_ECHOES("ATYPICAL DISRUPTED WAKE ECHOES","disruptedwakeechoes", ItemType.DATA, 0),
    ATYPICAL_ENCRYPTION_ARCHIVES("ATYPICAL ENCRYPTION ARCHIVES","encryptionarchives", ItemType.DATA, 0),
    CLASSIFIED_SCAN_FRAGMENT("CLASSIFIED SCAN FRAGMENT","classifiedscandata", ItemType.DATA, 0),
    ...
    DIVERGENT_SCAN_DATA("DIVERGENT SCAN DATA","encodedscandata", ItemType.DATA, 0),
    ECCENTRIC_HYPERSPACE_TRAJECTORIES("ECCENTRIC HYPERSPACE TRAJECTORIES","hyperspacetrajectories", ItemType.DATA, 0),
    EXCEPTIONAL_SCRAMBLED_EMISSION_DATA("EXCEPTIONAL SCRAMBLED EMISSION DATA","scrambledemissiondata", ItemType.DATA, 0),
    INCONSISTENT_SHIELD_SOAK_ANALYSIS("INCONSISTENT SHIELD SOAK ANALYSIS","shieldsoakanalysis", ItemType.DATA, 0),
    IRREGULAR_EMISSION_DATA("IRREGULAR EMISSION DATA","archivedemissiondata", ItemType.DATA, 0),
    MODIFIED_CONSUMER_FIRMWARE("MODIFIED CONSUMER FIRMWARE", "consumerfirmware", ItemType.DATA, 0),
    MODIFIED_EMBEDDED_FIRMWARE("MODIFIED EMBEDDED FIRMWARE","embeddedfirmware", ItemType.DATA, 0),
    ...
    PECULIAR_SHIELD_FREQUENCY_DATA("PECULIAR SHIELD FREQUENCY DATA","shieldfrequencydata", ItemType.DATA, 0),
    SECURITY_FIRMWARE_PATCH("SECURITY FIRMWARE PATCH","securityfirmware", ItemType.DATA, 0),
    ...
    TAGGED_ENCRYPTION_CODES("TAGGED ENCRYPTION CODES","encryptioncodes", ItemType.DATA, 0),
    ...
    UNUSUAL_ENCRYPTED_FILES("UNUSUAL ENCRYPTED FILES","encryptedfiles", ItemType.DATA, 0),
