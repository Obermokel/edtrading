...
import borg.edtrading.ocrOLD.fixer.ArgOfPeriapsisFixer;
import borg.edtrading.ocrOLD.fixer.AtmosphereTypeFixer;
import borg.edtrading.ocrOLD.fixer.AxialTiltFixer;
import borg.edtrading.ocrOLD.fixer.EarthMassesFixer;
import borg.edtrading.ocrOLD.fixer.GravityFixer;
import borg.edtrading.ocrOLD.fixer.MoonMassesFixer;
import borg.edtrading.ocrOLD.fixer.OrbitalEccentricityFixer;
import borg.edtrading.ocrOLD.fixer.OrbitalInclinationFixer;
import borg.edtrading.ocrOLD.fixer.OrbitalPeriodFixer;
import borg.edtrading.ocrOLD.fixer.RadiusFixer;
import borg.edtrading.ocrOLD.fixer.RingMassFixer;
import borg.edtrading.ocrOLD.fixer.RingRadiusFixer;
import borg.edtrading.ocrOLD.fixer.RingTypeFixer;
import borg.edtrading.ocrOLD.fixer.RotationalPeriodFixer;
import borg.edtrading.ocrOLD.fixer.SemiMajorAxisFixer;
import borg.edtrading.ocrOLD.fixer.SolarMassesFixer;
import borg.edtrading.ocrOLD.fixer.SolarRadiusFixer;
import borg.edtrading.ocrOLD.fixer.SurfacePressureFixer;
import borg.edtrading.ocrOLD.fixer.SurfaceTempFixer;
import borg.edtrading.ocrOLD.fixer.TidallyLockedFixer;
import borg.edtrading.ocrOLD.fixer.ValueFixer;
import borg.edtrading.ocrOLD.fixer.VolcanismFixer;
...
public class ScannedBodyInfo {
    ...
    private static void doAutoLearn(TemplateMatch m, String shouldHaveBeen, String screenshotFilename) {
        ...
        if (Constants.LEARN_0_VS_O || !is0vsO(shouldHaveBeen, m.getTemplate().getText())) {
            ...
            try {
                ImageIO.write(m.getMatchedImage(), "PNG", new File(autoLearnFolder, "LEARNED#" + folderName + "#" + m.getMatch().x + "#" + m.getMatch().y + "#" + screenshotFilename));
